                        ...
                        <div className="flex flex-col md:flex-row h-full w-full max-w-7xl mx-auto">
                            ...
                            <div className="w-full md:w-1/2 flex flex-col justify-center px-4 sm:px-6 md:px-8 py-8 md:py-0 text-center md:text-left z-10">
                                <div className="flex items-center justify-center md:justify-start mb-3">
                                    <Zap className="w-4 h-4 mr-2" style={{ color: slide.color }} />
                                    <span 
                                ...
                                <div className="flex justify-center md:justify-start">
                                    <button className={`flex items-center gap-2 bg-gradient-to-r ${slide.buttonColor} text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-sm sm:text-base font-medium relative overflow-hidden group`}>
                                        <span className="relative z-10 tracking-wide uppercase text-sm">SHOP NOW</span>
