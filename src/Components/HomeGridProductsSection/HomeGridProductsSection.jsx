...
import classes from "../HomeGridProductsSection/HomeGridProductsSection.module.css";
...
export default function HomeGridProductsSection() {
  ...
  function ProductGrid({ title, products }) {
    return (
        <div className="flex-1 min-w-[300px] p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
            <h2 className="text-lg font-bold text-gray-800 mb-4 pb-2 border-b-2 border-gray-100">
                {title}
            </h2>
